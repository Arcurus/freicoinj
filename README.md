...
Then run "mvn clean package -Dmaven.test.skip=true" to compile the software. You can also run "mvn site:site" to generate a website with
...
It will download the block chain and eventually print a Freicoin address. If you send coins to it,

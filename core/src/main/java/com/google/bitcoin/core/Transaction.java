...
public class Transaction extends ChildMessage implements Serializable {
  ...
  public static BigInteger getDemurrageInSatoshi(int old_height, int new_height, BigDecimal value) {
    BigDecimal fee = getDemurrage(old_height, new_height, value);

    return fee.setScale(8, BigDecimal.ROUND_HALF_UP).movePointRight(8).toBigIntegerExact();
  }
   ...
   */
  public static BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = BigInteger.valueOf(10000);
   ...
   */
  public static final BigInteger MIN_NONDUST_OUTPUT = CoinDefinition.DUST_LIMIT;//BigInteger.valueOf(5460);
  ...
  public Sha256Hash getHash() {
    if (hash == null) {
      ...
      //log.info("transaction hashing - Hash:"+hash.toString()+" ref: "+refheight+"\n\n\nraw:"+Utils.bytesToHexString(bits));
    }
    return hash;
  }
  ...
  protected void bitcoinSerializeToStream(OutputStream stream) throws IOException {
    ...
    //log.info("\n\n\n\n" + Utils.bytesToHexString(stream.toString().getBytes()));
  }
